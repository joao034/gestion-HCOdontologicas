    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                @if ($modo == 'show')
                    <input type="text" class="form-control" value="{{ $paciente->tipo_nacionalidad->nombre }}"
                        readonly>
                @else
                    <select class="form-select form-select-md" name="tipo_nacionalidad_id" id="" required
                        ...
                        @foreach ($tipos_nacionalidad as $tipo_nacionalidad)
                            <option value="{{ $tipo_nacionalidad->id }}"
                                {{ old('tipo_nacionalidad_id') == $tipo_nacionalidad->id || (($modo == 'show' || $modo == 'edit') && $paciente->tipo_nacionalidad_id == $tipo_nacionalidad->id) ? 'selected' : '' }}>
            ...
            <div class="col-md-6">
                <label for="" class="form-label fw-bold">Tipo de documento de identificación <span
                        class="text-danger">*</span></label>
                @if ($modo == 'show')
                    <input type="text" class="form-control" value="{{ $paciente->tipo_documento->nombre }}"
                        readonly>
                @else
            ...
            <div class="col-md-5">
                <div class="mb-3">
                    ...
                    <input type="date"
                        ...
                        id="fecha_nacimiento" max="<?php echo date('Y-m-d'); ?>" id="fechaNacimiento" placeholder="dd/mm/aaaa"
        ...
        <div class="row">
            <div class="col-md-6">
                <label for="" class="form-label fw-bold">Estado civil <span
                        class="text-danger">*</span></label>
                @if ($modo == 'show')
                    <input type="text" class="form-control" value="{{ strtoupper($paciente->estado_civil) }}"
                        readonly>
                @else
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text"
                        ...
                        {{ $modo == 'show' ? 'readonly' : '' }} class="form-control" name="celular" minlength="10"
                        maxlength="10" id="celular" aria-describedby="helpId"
