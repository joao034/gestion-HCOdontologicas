            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ old('nombres') }}" class="form-control" name="nombres"
                            id="" aria-describedby="helpId" placeholder="Escriba los nombres del paciente"
                            required autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ old('apellidos') }}" class="form-control" name="apellidos"
                            id="" aria-describedby="helpId" placeholder="Escriba los apellidos del paciente"
                            required>
                        @error('apellidos')
                            <small class="text-danger"> {{ $message }}</small>
                        @enderror
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="cedula" value="{{ old('cedula') }}"
                                minlength="10" maxlength="16" id="cedula" aria-describedby="helpId"
                                placeholder="Escriba el nro de identificación del paciente" >
                            @error('cedula')
                                <small class="text-danger"> {{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-5">
                        <div class="mb-3">
                            <label for="" class="form-label fw-bold">Fecha de Nacimiento <span
                                    class="text-danger">*</span></label>
                            <input type="date" value="{{ old('fecha_nacimiento') }}" class="form-control"
                                name="fecha_nacimiento" id="fecha_nacimiento" max="<?php echo date('Y-m-d'); ?>"
                                id="fechaNacimiento" placeholder="dd/mm/aaaa" pattern="\d{2}/\d{2}/\d{4}" required>
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('edad') }}" class="form-control" name="edad"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ old('cedula_representante') }}"
                                    name="cedula_representante" minlength="10" maxlength="10" id=""
                                    aria-describedby="helpId" placeholder="Escriba la cédula del representante"
                                    pattern="^[0-9]+$">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ old('representante') }}"
                                    name="representante" id="representante" aria-describedby="helpId"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="estado_civil" id="" class="form-select form-select-md" required>
                            ...
                            <option value="unionlibre" {{ old('estado_civil') == 'unionlibre' ? 'selected' : '' }}>
                                Unión
                                Libre</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('telef_convencional') }}" id="telefono"
                                class="form-control" name="telef_convencional" id=""
