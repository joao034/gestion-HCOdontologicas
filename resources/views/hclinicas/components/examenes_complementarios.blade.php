    ...
    <div class="card-body">
        ...
        <div class="form-floating mt-2">
            <textarea class="form-control" style="height: 80px" id="examenes_solicitados" name="examenes_solicitados"
                required {{ $modo == 'show' ? 'readonly' : '' }}>{{ $modo == 'show' || $modo == 'edit' ? $hClinica->examenComplementario?->examenes_solicitados : old('examenes_solicitados') }}</textarea>
    ...
    <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <input class="form-check-input border-primary" type="checkbox" id="checkbox{{ $key }}"
                            ...
                            {{ ($modo == 'show' || $modo == 'edit') && $hClinica->examenComplementario?->retornar_tipos_examen($key) == true ? 'checked' : '' }}>
        ...
        <div class="form-floating mt-2">
            <textarea class="form-control" style="height: 80px" name="observaciones"
                required {{ $modo == 'show' ? 'readonly' : '' }}>{{ $modo == 'show' || $modo == 'edit' ? $hClinica->examenComplementario?->observaciones : old('observaciones') }}</textarea>
