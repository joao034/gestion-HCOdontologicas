<div class="d-flex flex-wrap">
    ...
    @else
        ...
        <div class="mb-3">
            ...
            <select required class="form-select form-select-md" name="odontologo_id" id="odontologoSelect" onchange="selectOdontologo()" >
    ...
    <div>
        ...
        <input type="text" value="{{ $paciente->historias_clinicas->first()?->odontologo->cedula }}" id="numero_registro"
